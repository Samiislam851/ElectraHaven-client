...
const SingleItem = () => {
    ...
    console.log('fulfilled standards', productData?.fulfilledStandards);
                    ...
                    <div className='max-w-[1600px] md:px-20 mx-auto px-5 py-20 md:pb-40'>
                        <div className='flex gap-5 shadow p-10 justify-center'>
                            ...
                            <div className='basis-[60%] p-5'>
                                ...
                                {productData?.fulfilledStandards[0].toLowerCase() == 'n/a' ? <></> : <>   <div className='py-5 flex flex-col md:flex-row gap-2 items-center justify-center md:justify-start'>
