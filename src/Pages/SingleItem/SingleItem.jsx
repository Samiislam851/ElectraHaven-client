...
const SingleItem = () => {
    ...
    const { user, setCartToggle, cartToggle } = useContext(AuthContext);
    ...
    const addToCart = () => {
        ...
        axios.post('cart/', cart).then(res => {
            ...
            if (res.data.acknowledged) {
                console.log('hellooooooooooooooooooooooooo from inside');
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                        ...
                        <div className='flex gap-5 shadow p-10 justify-center'>
                            ...
                            <div className='basis-[60%] p-5'>
                                ...
                                <div className='flex flex-col  gap-3 pt-5 '>
                                    ...
                                    </span> <span className='text-gray-500 '> {productData.availablePieces} </span> </p>
